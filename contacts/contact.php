...
$subject ="Новая заявка с сайта dukascopy";
...
$header .= "From: Новая заявка <iearnininternet@gmail.com>\n\n";	
$mail = mail("iearnininternet@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
